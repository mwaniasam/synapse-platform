    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      <Card className="glass-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <CardTitle className="text-lg font-semibold">Study Time</CardTitle>
        ...
        <CardContent className="space-y-3">
          <div className="text-3xl font-bold">{Math.floor(stats.totalStudyTime / 60)}h {stats.totalStudyTime % 60}m</div>
      ...
      <Card className="glass-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group">
        ...
        <CardContent className="space-y-3">
          <div className="text-3xl font-bold">{stats.resourcesCompleted}</div>
          <p className="text-sm text-muted-foreground">
      ...
      <Card className="glass-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <CardTitle className="text-lg font-semibold">Focus Score</CardTitle>
        ...
        <CardContent className="space-y-3">
          <div className="text-3xl font-bold">{stats.averageFocus}%</div>
          <p className="text-sm text-muted-foreground">
      ...
      <Card className="glass-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <CardTitle className="text-lg font-semibold">Comprehension</CardTitle>
          <div className="w-12 h-12 bg-gradient-to-br from-teal-500/20 to-cyan-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            <TrendingUp className="h-6 w-6 text-teal-600" />
          </div>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="text-3xl font-bold">{stats.comprehensionScore}%</div>
          <p className="text-sm text-muted-foreground">
